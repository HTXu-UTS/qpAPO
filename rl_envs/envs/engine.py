#!/usr/bin/env python
import os
os.add_dll_directory("C://Users//MyWork//.mujoco//mujoco210//bin")
import gym
import gym.spaces
import numpy as np
...
from rl_envs.envs.world import World, Robot
...
class Engine(gym.Env, gym.utils.EzPickle):
    ...
    def seed(self, seed=None):
        ...
        self._seed = np.random.randint(2**31) if seed is None else seed
